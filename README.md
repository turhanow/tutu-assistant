...
Проект содержит 277 unit-, contract- и интеграционных тестов, offline eval-наборы для AI-сценариев и coverage gate не ниже 80%. CI проверяет Ruff, форматирование, схемы, fixtures, секреты, зависимости и сборку wheel/container.
